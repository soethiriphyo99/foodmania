                                                    ...
                                                    <table class="table">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-color"><strong> <?php echo  $item_total . "MMK"; ?></strong></td>
                                                            </tr>
                                                        </tbody>
                                                    ...
                                                    <li>
                                                        <label class="custom-control custom-radio  m-b-10">
                                                            ...
                                                            <span class="custom-control-description">
                                                                <img src="images/paymentopt.jpg" alt="" width="110">
                                                            </span>
                                                        </label>
                                                    </li>
                                                </ul>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-sm-3 payment-options color-gray">
                            ...
                            <ul>
                                <li>
                                    <a href="#"> <img src="images/oaya.jpg" width="32" height="23" alt="AYA"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="images/ocb.jpg" width="32" height="23" alt="CB"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="images/mastercard.png" alt="Mastercard"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="images/okbz.jpg" width="32" height="23" alt="KBZ"> </a>
                                </li>
                                <li>
                                    <a href="#"> <img src="images/owavemoney.png" width="32" height="23" alt="Wavemoney"> </a>
                                </li>
